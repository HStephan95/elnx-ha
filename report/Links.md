...
[Example make-file](https://www.drupal.org/docs/develop/packaging-a-distribution/example-drupalorg-make-file)

[Using a Drush make-file](http://docs.drupalvm.com/en/latest/deployment/drush-make/)

## Open Source contributies

*to do*

## Niewe technologie

[Ansible-vault voorbeeld](https://leucos.github.io/articles/transparent-vault-revisited/)

[Ansible-vault docs](https://docs.ansible.com/ansible/2.4/vault.html)

[Vault in playbooks](http://docs.ansible.com/ansible/latest/playbooks_vault.html)
